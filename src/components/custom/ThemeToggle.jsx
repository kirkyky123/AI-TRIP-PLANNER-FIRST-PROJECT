...
export function ThemeToggle() {
  ...
  return (
    <Button
      ...
      className="bg-transparent dark:border-black hover:bg-gray-100 dark:hover:bg-gray-900 border-gray-700 border-2 rounded-xl hover:scale-105 transition-all duration-300"
    >
